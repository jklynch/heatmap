...
input_file_path = os.path.expanduser('~/Dropbox/as_fe_data_sln/minnesota_cores/dissolution_results/southern_counties_mid_tills_2010_dissolution_results.txt')
