...
core_df = pd.read_csv(input_file_path, sep='\t', index_col='field_no', skiprows=[0,2])
core_df = core_df.loc[:, 'Ag':'Se']

print(core_df)

# do not use for UMRB2?
figure_size = None
figure_size = (10, 10)
...
heatmapAX.set_yticklabels(core_df.index[row_denD['leaves']])
