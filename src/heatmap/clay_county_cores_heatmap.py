...
input_file_path = os.path.expanduser('~/Dropbox/as_fe_data_sln/Clay County heatmap files/Clay Co Anaerobic co_located As and Fe for heat_map.txt')
...
all_core_df = pd.read_csv(input_file_path, sep='\t', index_col=0)
